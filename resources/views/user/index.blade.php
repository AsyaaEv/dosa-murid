    ...
    <section class="w-screen h-screen relative">
        ...
        <div
            ...
            <div
                ...
                <div class="font-semibold text-white text-lg">Selamat Datang</div>
                ...
                <form action="{{ route('siswa.user.result') }}"
                ...
                <div class="w-full h-auto mt-4 flex justify-center items-center">
                    <h1 class="text-md text-white font-medium">Masuk Sebagai Admin?</h1>
                    <a href="{{ route('siswa.index')}}" class="text-md text-white font-medium ml-2 py-2 px-2 bg-blue-700 rounded-[10px] hover:scale-[1.1] transition-all">Klik</a>
                </div>
